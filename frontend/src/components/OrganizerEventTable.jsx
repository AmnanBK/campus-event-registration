    ...
    <div className="overflow-x-auto">
      <div className="min-w-[900px]"> {/* Min-width biar ga hancur di HP */}
        ...
        <div className="bg-neutral-soft border-b border-neutral-border grid grid-cols-12 gap-4 px-6 py-4">
          <div className="col-span-4 text-table-header text-neutral-secondary">Judul Acara</div>
          ...
          <div className="col-span-1 text-table-header text-neutral-secondary text-center">Status</div>
          ...
          {events.length > 0 ? (
            events.map((event) => (
              <div key={event.id} className="grid grid-cols-12 gap-4 px-6 py-5 items-center hover:bg-neutral-soft/30 transition-colors">
                ...
                {/* Judul */}
                <div className="col-span-4 text-body font-medium text-neutral-main truncate pr-2">
                  {event.title}
                </div>
                ...
                <div className="col-span-1 flex justify-center">
                  <span className={`text-body px-3 py-1 rounded-full border ${
                    ...
                    : 'bg-neutral-soft text-neutral-secondary border-neutral-border'
                  }`}>
                    {event.status}
                  </span>
                </div>
